...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/pip_select.sh|bash
	...
	if [ -f $pyenv_path/pyenv/bin/python ];then
		...
		if [ $? -eq 0 ] && [ -z "${is_ssl}" ];then
			...
			if [ "$is_package" = "" ];then
				wget -O $pyenv_path/pyenv/pip.txt $download_Url/install/pyenv/pip.txt 
	...
	wget -O $python_src $download_Url/src/Python-${py_version}.tar.xz 
	...
	cd ~
	rm -rf $python_src_path
	wget -O $pyenv_path/pyenv/bin/activate $download_Url/install/pyenv/activate.panel 
	wget -O $pyenv_path/pyenv/pip.txt $download_Url/install/pyenv/pip-3.7.8.txt 
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/public.sh -T 10
	wget -O panel.zip https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/src/bt7.init -T 10
