...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/update6_en.sh|bash
	else
		curl https://gcore.jsdelivr.net/gh/fqdata/btpanel7.7/install/update6.sh|bash
	fi
